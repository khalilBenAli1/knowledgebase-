    ...
    <div className="flex h-full relative">
      ...
      <div className="flex-1 flex flex-col bg-white">
        ...
        <div className="md:hidden flex items-center gap-3 px-4 py-3 border-b border-gray-200 bg-white sticky top-0 z-10">
          ...
          <h2 className="text-lg font-semibold text-biat-primary">Chat</h2>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-3 md:p-6">
          {messages.length === 0 && !loading && (
            <div className="text-center mt-10 md:mt-20 px-4">
              ...
              <h2 className="text-xl md:text-3xl font-bold text-biat-primary mb-3 md:mb-4">Assistant IA - Règlement Intérieur</h2>
              <p className="text-biat-secondary/70 text-sm md:text-lg">Posez vos questions sur le règlement intérieur d'Assurances BIAT</p>
            </div>
          )}
