    ...
    <div className="flex h-full relative">
      ...
      `}>
        ...
        <div className="flex-1 overflow-y-auto p-4">
          {showSearch ? (
            ...
            <>
              <h3 className="text-sm font-semibold text-biat-secondary dark:text-biat-300 mb-2">Historique</h3>
                  ...
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-all ${
                      currentSessionId === session.id
                        ? 'bg-biat-100 dark:bg-biat-900 text-biat-primary dark:text-biat-300 font-semibold border border-biat-200 dark:border-biat-700'
      ...
      <div className="flex-1 flex flex-col bg-white dark:bg-gray-900">
        ...
        <div className="md:hidden flex items-center gap-3 px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 sticky top-0 z-10">
          ...
          <h2 className="text-lg font-semibold text-biat-primary dark:text-biat-300">Assistant RH</h2>
        </div>

        <div className="flex-1 overflow-y-auto p-3 md:p-6">
          {messages.length === 0 && !loading && (
            <div className="text-center mt-10 md:mt-20 px-4">
              <div className="inline-block bg-biat-50 dark:bg-biat-900/30 p-4 md:p-6 rounded-2xl mb-4 md:mb-6">
                <svg className="w-12 h-12 md:w-20 md:h-20 text-biat-primary dark:text-biat-300 mx-auto" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M10.394 2.08a1 1 0 00-.788 0l-7 3a1 1 0 000 1.84L5.25 8.051a.999.999 0 01.356-.257l4-1.714a1 1 0 11.788 1.838L7.667 9.088l1.94.831a1 1 0 00.787 0l7-3a1 1 0 000-1.838l-7-3zM3.31 9.397L5 10.12v4.102a8.969 8.969 0 00-1.05-.174 1 1 0 01-.89-.89 11.115 11.115 0 01.25-3.762zM9.3 16.573A9.026 9.026 0 007 14.935v-3.957l1.818.78a3 3 0 002.364 0l5.508-2.361a11.026 11.026 0 01.25 3.762 1 1 0 01-.89.89 8.968 8.968 0 00-5.35 2.524 1 1 0 01-1.4 0zM6 18a1 1 0 001-1v-2.065a8.935 8.935 0 00-2-.712V17a1 1 0 001 1z"/>
                </svg>
              </div>
              <h2 className="text-xl md:text-3xl font-bold text-biat-primary dark:text-biat-300 mb-3 md:mb-4">Assistant RH</h2>
              <p className="text-biat-secondary/70 dark:text-gray-400 text-sm md:text-lg">Votre assistant intelligent pour les questions RH et le règlement intérieur d'Assurances BIAT</p>
            </div>
          )}
            ...
            <form onSubmit={handleSendMessage}>
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <Autocomplete
                  ...
                  className="flex-1 px-5 py-4 md:px-6 md:py-5 text-lg md:text-xl border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 rounded-xl focus:outline-none focus:ring-2 focus:ring-biat-primary focus:border-biat-primary transition-all shadow-sm"
                  disabled={loading}
                />
                <button
                  type="submit"
