    ...
    <div className="h-full flex flex-col bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-4 py-3">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-sm text-gray-600 mt-1">Suivez l'état de vos demandes de formation</p>
                  ...
                  <div key={request.id} className="bg-white rounded-lg shadow border border-gray-200 p-4">
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        <h3 className="text-lg font-bold text-biat-primary mb-1">
                    ...
                    {/* Status Description */}
                    <p className="text-xs text-gray-600 mb-3">{statusInfo.description}</p>
                    ...
                    {request.hrResponse && (
                      <div className={`mb-2 p-2 rounded text-xs ${
                        ...
                        <p className={request.status === 'APPROVED' || request.status === 'approved' ? 'text-green-900' : 'text-red-900'}>
                    ...
                    <div className="mt-3 pt-3 border-t border-gray-200">
                      <div className="flex items-center gap-3 text-xs">
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-gray-600">Demandée</span>
                        </div>
                        <div className="flex-1 h-0.5 bg-gray-200"></div>
                        <div className="flex items-center gap-1.5">
                          <div className={`w-2 h-2 rounded-full ${
                            request.reviewedAt ? 'bg-green-500' : 'bg-gray-300'
                          }`}></div>
                        ...
                        <div className="flex items-center gap-1.5">
                          <div className={`w-2 h-2 rounded-full ${
                            request.hrReviewedAt ? 'bg-green-500' : 'bg-gray-300'
                          }`}></div>
