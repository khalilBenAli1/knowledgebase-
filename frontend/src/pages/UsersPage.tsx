          ...
          <div className="p-6 border-b border-gray-200">
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pl-12 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-biat-primary focus:border-transparent"
              />
              <svg
                ...
                <tr key={user.id} className="hover:bg-gray-50 transition-colors">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="flex-shrink-0 h-10 w-10 bg-biat-100 rounded-full flex items-center justify-center">
                        <span className="text-biat-primary font-semibold text-sm">
                          {user.name.charAt(0).toUpperCase()}
                        </span>
                      </div>
                      <div className="ml-4">
                        <div className="text-sm font-medium text-biat-secondary">{user.name}</div>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <select
                      ...
                      className="text-sm border border-gray-300 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-biat-primary"
                    >
                      {roles.map((role) => (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full mx-4">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-biat-primary">Inviter un utilisateur</h2>
              <button
            ...
            <form onSubmit={handleInviteUser} className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-biat-secondary mb-2">Nom complet</label>
                <input
                  type="text"
                  value={inviteName}
                  onChange={(e) => setInviteName(e.target.value)}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-biat-primary focus:border-transparent"
              ...
              <div>
                <label className="block text-sm font-medium text-biat-secondary mb-2">Adresse e-mail</label>
                <input
                  type="email"
                  value={inviteEmail}
              ...
              <div>
                <label className="block text-sm font-medium text-biat-secondary mb-2">Rôle</label>
                <select
                  value={inviteRole}
