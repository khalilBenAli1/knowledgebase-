...
const updatedContent = `import { BrowserRouter, Routes, Route, Navigate } from 'react-router-dom';
...
try {
  ...
  console.log('  - /actualites/:id → ActualityDetailPage');
  console.log('  - /manager → ManagerDashboardPage');
  console.log('  - /hr/catalog → HRCatalogUploadPage');
} catch (error) {
